          ...
          ?>
              <div class="col-md-6 col-lg-3">
                <div class="card text-dark bg-light">
                  <img src="Images/<?php echo $row['image'] ?>" id="myImg" class="card-img-top " style="height: 200px;">
                  <div class="card-body">
                    <h2 class="card-title"><?php echo $row['image_title']; ?></h2>
                    <h3 class="card-title price">₹<?php echo $row['image_price']; ?></h3>
                    <h6 class="card-title"><?php echo $row['image_text']; ?></h6>
                    <p class="card-text"><small class=""><i class="fa fa-list" aria-hidden="true"></i> Painting Type <b><?php echo $row['category']; ?></b></small></p>
                    <p class="card-text"><small class=""><i class="fa fa-user" aria-hidden="true"></i> Uploaded on <b><?php echo $row['image_date']; ?></b></small></p>
              ...
              <div class="row">
                <div class="col-sm-12 text-center form-div">
                  <div class="form-group">
                    <img src="cssimages/mypaintingsempty.svg" class="nono">
                    <h2 style="color:gray; margin-top:20px"><small>You haven't uplaoded anything yet.</small></h2>
                  </div>
                <?php } ?>
