        ...
        <div class="container-fluid">
            ...
            <div class="contain">
                <div class="row">
                    ...
                    $query = "SELECT i.*,u.username,country,email from images i,users u where u.id=user_id && i.category='Surrealism'";
